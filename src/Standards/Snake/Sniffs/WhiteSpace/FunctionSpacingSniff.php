...
class FunctionSpacingSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($this->rulesetProperties === null) {
            ...
            if (isset($phpcsFile->ruleset->ruleset['Snake.WhiteSpace.FunctionSpacing']) === true
                && isset($phpcsFile->ruleset->ruleset['Snake.WhiteSpace.FunctionSpacing']['properties']) === true
            ) {
                $this->rulesetProperties = $phpcsFile->ruleset->ruleset['Snake.WhiteSpace.FunctionSpacing']['properties'];
